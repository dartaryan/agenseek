  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // IMPORTANT: Fixed positioning must be properly centered
        'fixed z-50 grid w-full gap-4 border bg-background shadow-lg duration-200',
        // Mobile: full-screen
        'left-0 right-0 bottom-0 top-0 p-6',
        // Desktop: centered with proper transform
        'sm:left-1/2 sm:top-1/2 sm:right-auto sm:bottom-auto sm:-translate-x-1/2 sm:-translate-y-1/2 sm:max-w-lg sm:rounded-lg',
        // Animations
