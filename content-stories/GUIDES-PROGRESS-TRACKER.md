...
2. `content-stories/stories/agents/game-agents.md` - הסטורי המפורט
3. `src/content/locale/he/guides/agents/intro-pm-analyst.json` - מדריך אגנטים קודם (דוגמה)
