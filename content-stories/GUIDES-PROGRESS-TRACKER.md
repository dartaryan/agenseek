...
2. `content-stories/stories/roles/architects.md` - הסטורי המפורט
...
5. `src/content/locale/he/guides/roles/product-managers.json` - המדריך שזה עתה הושלם

**היכן לשמור:**
- `src/content/locale/he/guides/roles/architects.json`

**לא לשכוח:**
- **⚠️ זה מדריך ארוך (50 דקות) - יש ליצור אותו בחלקים של 700 שורות!**
