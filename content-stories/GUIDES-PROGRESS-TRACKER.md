...
**פרטים:**
- **כותרת:** מדריך למנהלי פרויקטים וסקראם מאסטרים
- **קטגוריה:** roles
...
2. `content-stories/stories/roles/project-managers.md` - הסטורי המפורט
3. `src/content/locale/he/guides/core/quick-start.json` - דוגמה מוכנה
4. `src/content/locale/he/guides/roles/ux-designers.json` - המדריך שזה עתה הושלם
5. `src/content/locale/he/guides/roles/qa-testers.json` - דוגמה נוספת

**היכן לשמור:**
- `src/content/locale/he/guides/roles/project-managers.json`

**לא לשכוח:**
- **⚠️ זה מדריך בינוני (35 דקות) - יכול להידרש יצירה בחלקים!**
