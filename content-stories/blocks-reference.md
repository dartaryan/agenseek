...
- `markdown`: **boolean** (אופציונלי, ברירת מחדל: true) - תמיכה במארקדאון inline
...
{
  "type": "text",
  "content": "BMAD הוא **מערכת ניהול פרויקטים** המבוססת על אגנטים. הוא מאפשר לכם לעבוד עם *אגנטים מקצועיים* שמבינים את התפקיד שלכם."
}
```
...
- ✅ השתמש במארקדאון להדגשות חשובות
